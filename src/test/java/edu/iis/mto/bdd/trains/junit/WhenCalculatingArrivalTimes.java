...
public class WhenCalculatingArrivalTimes {
    ...
    private Line line;
    private String departureFrom = "Epping", destination = "Central";
    ...
    @Test
    public void shouldFindMultipleDepartures() {
        List<LocalTime> departuresTimes = Arrays.asList(
                new LocalTime(7, 59),
                new LocalTime(8, 0),
                new LocalTime(8, 1),
        ...
        assertThat(intineraryService.findNextDepartures(departureFrom, destination, new LocalTime(8, 0)), equalTo(expected));
    }
}
